...
Git log is the authoritative record of what shipped. `php artisan test` should be green (133 tests as of end of M5, including 8 Playwright browser tests).
...
- `tests/Browser/` — `LibraryDrillDownTest`, `SearchTest`, `PlaylistDetailTest`, `SidebarFoldersTest` (Playwright, hit live Plex). `tests/Browser/Screenshots/` is gitignored.
