...
Git log is the authoritative record of what shipped. `php artisan test` should be green (155 tests after the sidebar cleanup pass (post-M5), including 8 Playwright browser tests).
